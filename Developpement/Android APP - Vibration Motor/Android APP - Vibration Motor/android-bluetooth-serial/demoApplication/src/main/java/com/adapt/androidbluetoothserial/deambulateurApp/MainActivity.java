...
import com.adapt.androidbluetoothserial.deambulateurApp.viewModel.MainActivityViewModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("MAIN", String.valueOf(this.getResources().getConfiguration().getLocales()));
    ...
    // Called when clicking on a device entry to start the CommunicateActivity
    public void openPagerActivity(String deviceName, String macAddress) {
    ...
    private class DeviceViewHolder extends RecyclerView.ViewHolder {
        ...
        void setupView(BluetoothDevice device) {
            ...
            layout.setOnClickListener(view -> openPagerActivity(device.getName(), device.getAddress()));
